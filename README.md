...
- [ ] **교란 감사 하네스.** 도구가 틀린 값을 돌려줄 때 에이전트가 알아채는지 측정. W08 파일럿에서
      비용을 잰 뒤 본실행 여부를 정합니다. 조건 C(ToolUniverse 에이전트)도 같은 시점에 정합니다.
...
> 완벽한 결과물보다, 함께 실험하고 실제로 돌아가는 무언가를 남기는 것이 목표입니다.
...
- **빌더**: [@ybaeus](https://github.com/ybaeus). 프로젝트 기획과 운영을 맡습니다.
